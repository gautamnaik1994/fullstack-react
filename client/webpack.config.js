...
function getPlugins() {
  myPlugins = [
    ...
    new htmlWebpackPlugin({ template: 'views/index.html', inject: 'body' }),
    ...
    new webpack.DefinePlugin({
      STRIPE_KEY: JSON.stringify('pk_test_BblYXl6hhxS3l6ik17JHMGQ4'),
    }),
  ...
  if (isProd) {
    myPlugins.push(new ExtractTextPlugin({ filename: '[name].[chunkhash].css', allChunks: true }));
    myPlugins.push(
